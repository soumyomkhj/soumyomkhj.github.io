...
class App{
	constructor(){
		...
		const ambient = new THREE.HemisphereLight(0xffff88, 0xbbbbff, 0.5);
		this.scene.add(ambient);

        // Create a directional light and add it to the scene
        // Parameters: Light Color
        // The light target is the origin by default.
        const light = new THREE.DirectionalLight( 0xffff55 );
        ...
        const material = new THREE.MeshStandardMaterial( { color: 0x08c49f });
